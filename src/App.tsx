  ...
  return (
    <div className="app">
      <header className="app-header">
        ...
        <div className="privacy-badge" role="note" aria-label="Privacy notice">
        ...
        <section className="input-section" aria-labelledby="input-label">
          ...
          <div className="textarea-wrapper">
            <textarea
              ...
              aria-label="Enter characters to number"
              autoComplete="off"
              autoCorrect="off"
              autoCapitalize="off"
              spellCheck={false}
          ...
          <div className="controls">
            <button
              ...
              aria-pressed={hidden}
              aria-label={hidden ? 'Show characters' : 'Hide characters'}
            >
            ...
            <button
              ...
              aria-label="Copy position list to clipboard"
              aria-live="polite"
            >
        ...
        {entries.length > 0 && (
          <section className="grid-section" aria-labelledby="grid-label">
            ...
            <div
              className="char-grid"
              role="list"
              aria-label="Character positions"
            >
              {entries.map(entry => (
                <div
                  key={entry.position}
                ...
                >
                  <span className="tile-char" aria-hidden="true">
                    {displayChar(entry, hidden)}
                  </span>
                  <span className="tile-pos" aria-hidden="true">
                    {entry.position}
                  </span>
                </div>
              ))}
            ...
            <div className="empty-grid-preview">
              {['?', '?', '?', '?', '?'].map((_, i) => (
                <div key={i} className="char-tile char-tile--ghost">
                  ...
                  <span className="tile-pos">{i + 1}</span>
                </div>
              ))}
            </div>
      ...
      <footer className="app-footer">
        <p>
          <strong>Privacy:</strong> This app runs entirely in your browser. No data leaves your device.
          No cookies. No analytics. No server. Works offline.
        </p>
        <p className="footer-meta">
          Open source · Free forever · <a href="https://github.com" rel="noopener noreferrer" target="_blank">View source</a>
        </p>
      </footer>
    </div>
  )
